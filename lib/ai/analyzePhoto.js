...
const MODELS = [
  "google/gemma-4-26b-a4b-it:free",  // Gemma 4 multimodal — confirmed working
...
{"quality":"good","issues":[{"description":"<specific repair description>","category":"<Roofing|Plumbing|Electrical|HVAC|Structural|Flooring|Painting|Other>","severity":"<high|medium|low>","estimated_cost":<integer USD>,"confidence":<0.0-1.0>,"needs_closer_look":<true|false>,"closer_photo_note":"<null or brief instruction like 'Get closer to the ceiling stain'>"}]}
...
- needs_closer_look = true if a closer/better photo would meaningfully improve accuracy
- closer_photo_note = a brief instruction for the follow-up shot, or null if not needed
...
async function callModel(model, dataUrl) {
  const res = await fetch("https://openrouter.ai/api/v1/chat/completions", {
    ...
    headers: {
      ...
      "HTTP-Referer": "https://fixfrompix.app",
      "X-Title": "FixFromPix",
    },
    body: JSON.stringify({
      model,
